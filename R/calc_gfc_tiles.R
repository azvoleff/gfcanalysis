...
#' @export
#' @import sp
#' @param aoi an Area of Interest (AOI). If the AOI is not in the WGS84 
#' geographic coordinate system, it will be reprojected to WGS84.
